...
def args_parse():
    ...
    parser.add_argument('--output', type=str, nargs=1, help="Enter save folder",
                        required=False)  # only false if using config file
    parser.add_argument('--skew_direction', type=str, nargs=1, help="Enter the direction of skew (default is Y)",
                        default="Y")
    parser.add_argument('--deskew_angle', type=float, nargs=1, help="Enter the deskew angle (default is 30)",
                        default=30.0)
    parser.add_argument('--processing', type=str, nargs=1,
                        help="Enter the processing option: deskew, crop, workflow or workflow_crop", required=False)
    parser.add_argument('--deconvolution', type=str, nargs=1,
